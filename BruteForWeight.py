...
for bruteforce in range(0, 100000000):
    ...
    if best < all_over_best[1]:
        all_over_best = [best, bestitems]
        print('#: ' + str(bruteforce) + ', Unloaded items: ' + str(all_over_best[1]) + ', Wastedweight: ' + str(all_over_best[0]) + '.')
